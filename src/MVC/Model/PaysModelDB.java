...
public class PaysModelDB extends DAOPays {
    ...
    public boolean removePays(Pays pays) {
        String query = "delete from APIPAYS where id_pays = ?";
    ...
    public Pays updatePays(Pays pays) {
        String query = "update APIPAYS set sigle =?, nom=?, langue=? where id_pays = ?";
        try(PreparedStatement pstm = dbConnect.prepareStatement(query)) {
    ...
    public Pays readPays(int idPays) {
        String query = "select * from APIPAYS where id_pays = ?";
        try(PreparedStatement pstm = dbConnect.prepareStatement(query)) {
